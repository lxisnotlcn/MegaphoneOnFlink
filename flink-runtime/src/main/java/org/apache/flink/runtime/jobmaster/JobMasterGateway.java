...
public interface JobMasterGateway extends
	...
	default void acknowledgeToController(JobID jobID, ExecutionAttemptID executionAttemptID, String taskname){
		throw new UnsupportedOperationException();
	}

	default void acknowledgeToController(JobID jobID, ExecutionAttemptID executionAttemptID, String taskname, AckMessage ack){
		throw new UnsupportedOperationException();
	}
}
