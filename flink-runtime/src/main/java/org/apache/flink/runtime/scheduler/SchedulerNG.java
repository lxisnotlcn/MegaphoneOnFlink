...
public interface SchedulerNG {
	...
	default void acknowledgeToController(JobID jobID, ExecutionAttemptID executionAttemptID){
		throw new UnsupportedOperationException();
	}

	default void acknowledgeToController(JobID jobID, ExecutionAttemptID executionAttemptID, AckMessage ack){
		throw new UnsupportedOperationException();
	}
}
