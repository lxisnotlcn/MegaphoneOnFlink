...
public interface StateBackend extends java.io.Serializable {
	...
	default BinaryState extractState(int index) throws FlinkException, IOException {//add for megaphone
	...
	default void applyState(byte[] bytes, int keyGroupIndex) throws FlinkException, IOException {
		throw new UnsupportedOperationException(
			"operation not supported by " + getClass().getName());
	}
}
