...
import org.apache.flink.runtime.megaphone.OperatorStatePartition;
...
public class FsStateBackend extends AbstractFileStateBackend implements ConfigurableStateBackend {
	...
	private Map<String, KeyedStateBackend> keyedStateBackends = new HashMap<>();//add for megaphone
	// -----------------------------------------------------------------------
	...
	public <K> AbstractKeyedStateBackend<K> createKeyedStateBackend(
		...
		HeapKeyedStateBackend<K> keyedStateBackend = new HeapKeyedStateBackendBuilder<>(//add for megaphone
			kvStateRegistry,
			keySerializer,
	...
	@Override
	public BinaryState extractState(int index) throws FlinkException, IOException {
	...
	@Override
	public void applyState(byte[] bytes, int keyGroupIndex) throws FlinkException, IOException {
		...
		for (int i = 0; i < nstate; i++) {
			...
			dd.read(buffer);
			keyedStateBackend.applyState(buffer, keyGroupIndex);
		}
