...
public final class DefaultJobTable implements JobTable {
	...
	private final class JobOrConnection implements JobTable.Job, JobTable.Connection {
		...
		@Override
		public RpcMegaphoneControllerResponder getMegaphoneResponder() {
			return verifyContainsEstablishedConnection().getMegaphoneResponder();
		}
		...
		public JobTable.Connection connect(
			...
			connection = new EstablishedConnection(
				...
				rpcMegaphoneControllerResponder);//add
	...
	private static final class EstablishedConnection {
		...
		private final RpcMegaphoneControllerResponder rpcMegaphoneControllerResponder;//add
		...
		private EstablishedConnection(
			...
			ResultPartitionConsumableNotifier resultPartitionConsumableNotifier,
			PartitionProducerStateChecker partitionStateChecker,
			RpcMegaphoneControllerResponder rpcMegaphoneControllerResponder) {
			...
			this.rpcMegaphoneControllerResponder = Preconditions.checkNotNull(rpcMegaphoneControllerResponder);//add
		}
		...
		public RpcMegaphoneControllerResponder getMegaphoneResponder() {//add
			return rpcMegaphoneControllerResponder;
		}
