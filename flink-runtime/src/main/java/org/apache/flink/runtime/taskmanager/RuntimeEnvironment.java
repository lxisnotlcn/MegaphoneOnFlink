...
import org.apache.flink.runtime.megaphone.RpcMegaphoneControllerResponder;
...
public class RuntimeEnvironment implements Environment {
	...
	private final RpcMegaphoneControllerResponder rpcMegaphoneControllerResponder;//add for megaphone
	...
	public RuntimeEnvironment(
			...
			RpcMegaphoneControllerResponder rpcMegaphoneControllerResponder,//add
		...
		this.rpcMegaphoneControllerResponder = checkNotNull(rpcMegaphoneControllerResponder);
		rpcMegaphoneControllerResponder.setTaskname(taskInfo.getTaskName());
	...
	@Override
	public void acknowledgeToController(
		JobID jobID,
		ExecutionAttemptID executionAttemptID,
		String taskName) {
		this.rpcMegaphoneControllerResponder.acknowledgeToController(jobID, executionAttemptID, taskName);
	}
	...
	public void acknowledgeToController(
		...
		String taskName,
		AckMessage ack) {
		this.rpcMegaphoneControllerResponder.acknowledgeToController(jobID, executionAttemptID, taskName, ack);
	}
}
