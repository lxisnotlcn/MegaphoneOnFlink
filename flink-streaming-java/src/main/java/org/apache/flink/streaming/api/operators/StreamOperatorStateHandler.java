...
public class StreamOperatorStateHandler {
	...
	public KeyGroupRange getKeyGroupRange(){// add for megaphone
		return null != keyedStateBackend ? keyedStateBackend.getKeyGroupRange() : KeyGroupRange.EMPTY_KEY_GROUP_RANGE;
	}
}
