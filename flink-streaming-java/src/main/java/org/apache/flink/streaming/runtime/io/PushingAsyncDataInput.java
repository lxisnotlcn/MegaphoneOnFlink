...
public interface PushingAsyncDataInput<T> extends AvailabilityProvider {
	...
	default Long getWatermark(){//add for megaphone
		System.out.println(this.getClass());
		throw new UnsupportedOperationException();
	}

	default void setControlWatermark(long controlWatermark, boolean isSource){
		throw new UnsupportedOperationException();
	}

	default void setStreamTaskAndMailbox(StreamTask streamTask, MailboxExecutor mailboxExecutor){
		throw new UnsupportedOperationException();
	}

	default void continueProcess(){
		throw new UnsupportedOperationException();
	}
